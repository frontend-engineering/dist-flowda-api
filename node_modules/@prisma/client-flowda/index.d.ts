...
export namespace Prisma {
  ...
  */
  ...
  export type DynamicTableDefColumnGetPayload<S extends boolean | null | undefined | DynamicTableDefColumnArgs> =
    ...
    [P in TruthyKeys<S['include']>]:
        P extends 'dynamicTableDef' ? DynamicTableDefGetPayload<S['include'][P]> :  never
  } 
    : S extends { select: any } & (DynamicTableDefColumnArgs | DynamicTableDefColumnFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'dynamicTableDef' ? DynamicTableDefGetPayload<S['select'][P]> :  P extends keyof DynamicTableDefColumn ? DynamicTableDefColumn[P] : never
  } 
      : DynamicTableDefColumn
  ...
  export type DynamicTableDataGetPayload<S extends boolean | null | undefined | DynamicTableDataArgs> =
    ...
    : S extends { select: any } & (DynamicTableDataArgs | DynamicTableDataFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'dynamicTableDef' ? DynamicTableDefGetPayload<S['select'][P]> :  P extends keyof DynamicTableData ? DynamicTableData[P] : never
  } 
      : DynamicTableData
