...
let OrderV4Router = OrderV4Router_1 = class OrderV4Router {
    constructor(trpc, orderV4, loggerFactory) {
        ...
        this.router = this.trpc.router({
            ...
            createNative: this.trpc.userProtectedProcedure.input(flowda_shared_types_1.createOrderSchema).mutation(({ input, ctx }) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                return this.orderV4.createNative(Object.assign({
                    tid: ctx.user.tenantId,
                    uid: ctx.user.id,
                }, input), ctx);
            })),
            createJSAPI: this.trpc.userProtectedProcedure.input(flowda_shared_types_1.createOrderSchema).mutation(({ input, ctx }) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                return this.orderV4.createJSAPI(Object.assign({
                    tid: ctx.user.tenantId,
                    uid: ctx.user.id,
                }, input));
            })),
            createQuick: this.trpc.tenantProtectedProcedure.input(flowda_shared_types_1.createQuickOrderSchema).mutation(({ input, ctx }) => tslib_1.__awaiter(this, void 0, void 0, function* () {
